  ...
  <?php
   if(isset($_POST['update']))
   {
     ...
     if($ad_image != "")
     {
       ...
       $sql = "UPDATE tb_upload_ads SET ad_title='$ad_title',ad_category='$ad_category',area='$area',ad_fixed_price_or_not='$ad_fixed_price_or_not',ad_price='$ad_price',ad_brand_name='$ad_brand_name',ad_description='$ad_description',ad_image='$dst_db' WHERE ad_id = $ad_id";

       $update_row = $db->update($sql);
     }

     $sql = "UPDATE tb_upload_ads SET ad_title='$ad_title',ad_category='$ad_category',area='$area',ad_fixed_price_or_not='$ad_fixed_price_or_not',ad_price='$ad_price',ad_brand_name='$ad_brand_name',ad_description='$ad_description' WHERE ad_id = $ad_id";
...
<body>
  ...
  <!-- ======= Hero Section ======= -->
  <section id="update_ads" class="pb-1 mb-1">
    <div class="container">
      <div class="row">
        <div class="col">
          <h5><i class="fa fa-pencil-square-o fa-fw" aria-hidden="true"></i> Update Ads</h5><hr>
        </div>
      </div>
    </div>
  </section><!-- End Hero -->
    ...
    <section id="ads_view" class="p-0 m-0">
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-9">
            <div class="card">
              <div class="card-header"><strong>Update Ads</strong></div>
              <div class="card-body">
                <form action="" method="post" id="update_ads_from" enctype="multipart/form-data">
                  <div class="form-group">
                    <label for="ad_title">Ad Title</label>
                    <input type="text" class="form-control" id="ad_title" name="ad_title" placeholder="Enter ad title" value="<?php echo $ad_title; ?>" required>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control" id="ad_fixed_price_or_not" name="ad_fixed_price_or_not" required>
                      <option><?php echo $ad_fixed_price_or_not; ?></option>
                      <option>YES</option>
                      <option>NO</option>
                    </select>
                  </div>
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="ad_price" name="ad_price" placeholder="Enter price" value="<?php echo $ad_price; ?>" required>
                  </div>
                  <div class="form-group">
                    <label for="ad_brand_name">Brand Name (If Any)</label>
                    <input type="text" class="form-control" id="ad_brand_name" name="ad_brand_name" placeholder="Enter brand name" value="<?php echo $ad_brand_name; ?>">
                  </div>
                  <div class="form-group">
                    <label for="ad_description">Product Description</label>
                    <textarea class="form-control" id="ad_description" name="ad_description" rows="4" cols="80" placeholder="Short description about product" required><?php echo $ad_description; ?></textarea>
                  </div>
                  <div class="form-group">
                    <img src="<?php echo $ad_image; ?>" height="100" weight="100" alt="">
