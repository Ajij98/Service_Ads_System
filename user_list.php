...
<body>
  ...
  <!-- ======= Hero Section ======= -->
  <section id="user_list" class="pb-1 mb-1">
    <div class="container">
      <div class="row">
        <div class="col">
          <h5><i class="fa fa-users fa-fw" aria-hidden="true"></i> User List</h5><hr>
        </div>
      </div>
    </div>
  </section><!-- End Hero -->
    ...
    <!-- ======= Services Section ======= -->
    <section id="user_list" class="p-0 m-0">
      <div class="container">
        <div class="row">
          <div class="col">
            <div class="card">
              ...
              <div class="card-body">
                <form action="" method="post">
                  <table id="user_list_table" class="table table-bordered display nowrap" style="width:100%">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td><?php echo $i; ?></td>
                        <td><img src="img/man.jpg" weight="50" height="50" alt=""></td>
                        <td><?php echo $result['user_username']; ?></td>
                        <td><?php echo $result['user_email']; ?></td>
                        <td><?php echo $result['entry_time']; ?></td>
                        <td><a href="view_user.php?user_id=<?php echo $result['user_id']; ?>" title="view" class="btn btn-info btn-sm"><i class="fa fa-eye fa-fw" aria-hidden="true"></i></a> <a href="delete_data.php?user_id=<?php echo $result['user_id']; ?>" onclick="return confirm('Sure to delete?')" title="delete" class="btn btn-danger btn-sm"><i class="fa fa-trash-o fa-fw" aria-hidden="true"></i></a></td>
                      </tr>
                      <?php } ?>
                      <?php }else{ ?>
