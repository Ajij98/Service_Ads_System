...
<body>
  ...
  <!-- ======= Hero Section ======= -->
  <section id="active_ads_adminside" class="pb-1 mb-1">
    <div class="container">
      <div class="row">
        <div class="col">
          <h5><i class="fa fa-check-square-o fa-fw" aria-hidden="true"></i> Active Ads</h5><hr>
        </div>
      </div>
    </div>
  </section><!-- End Hero -->
    ...
    <!-- ======= Services Section ======= -->
    <section id="active_ads_view" class="p-0 m-0">
      <div class="container">
        <div class="row">
          <div class="col">
            <div class="card">
              <div class="card-header"><strong>Active Ads</strong></div>
              <div class="card-body">
                <form action="" method="post">
                  <table id="active_ads_table" class="table table-bordered display nowrap" style="width:100%">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><a href="active_ads_view.php?ad_id=<?php echo $result['ad_id']; ?>" title="view" class="btn btn-info btn-sm"><i class="fa fa-eye fa-fw" aria-hidden="true"></i></a> <a href="delete_data.php?active_ad_id=<?php echo $result['ad_id']; ?>" onclick="return confirm('Are you sure you want to delete this item')" title="delete" class="btn btn-danger btn-sm"><i class="fa fa-trash-o fa-fw" aria-hidden="true"></i></a></td>
                      </tr>
                      <?php } ?>
                      <?php }else{ ?>
