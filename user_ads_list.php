<?php
 ...
 <?php
   ...
   $db   = new Database();
   $sql  = "SELECT * FROM tb_upload_ads WHERE u_name = '$user_name'";
   $read = $db->select($sql);
  ?>
...
<body>
  ...
  <!-- ======= Hero Section ======= -->
  <section id="user_ads_list" class="pb-1 mb-1">
    <div class="container">
      <div class="row">
        <div class="col">
          <h5><i class="fa fa-cubes fa-fw" aria-hidden="true"></i> My Ads</h5><hr>
        </div>
      </div>
    </div>
  </section><!-- End Hero -->
    ...
    <section id="ads_view" class="p-0 m-0">
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-9">
            <div class="card">
              <div class="card-header"><strong>My Ads</strong></div>
              <div class="card-body">
                <form action="" method="post">
                  <table id="user_ads_list_table" class="table table-bordered display nowrap" style="width:100%">
                        ...
                        <tr>
                          ...
                          <td>
                            <?php
                              ...
                              if($ad_status == 1)
                              {
                                $msg = '<div class="m-auto text-success"><strong>Confirmed</strong></div><br />';
                                echo $msg;
                              }
                              else
                              {
                          ...
                          <td><a href="make_payment.php" class="btn btn-success btn-sm">Make Payment</a></td>

                          <td><a href="view_user_ads.php?ad_id=<?php echo $result['ad_id']; ?>" title="view" class="btn btn-info btn-sm"><i class="fa fa-eye fa-fw" aria-hidden="true"></i></a> <a href="update_ads.php?ad_id=<?php echo $result['ad_id']; ?>" title="edit" class="btn btn-secondary btn-sm"><i class="fa fa-pencil-square-o fa-fw" aria-hidden="true"></i></a> <a href="delete_data.php?ad_id=<?php echo $result['ad_id']; ?>" onclick="return confirm('Are you sure you want to delete this item')" title="delete" class="btn btn-danger btn-sm"><i class="fa fa-trash-o fa-fw" aria-hidden="true"></i></a></td>
                        </tr>
                        <?php } ?>
                        <?php }else{ ?>
